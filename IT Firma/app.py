...
def dodajstudenta():
    ...
    if ulogovan():
        ...
        if request.method == "POST":
            ...
            upit = "INSERT INTO studenti (ime, ime_roditelja, prezime, email, broj_telefona, datum_rodjenja, jmbg, slika) VALUES(%s, %s, %s, %s, %s, %s, %s, %s)"
